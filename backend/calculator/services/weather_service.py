...
#     CurrentTariffModel, SolarForecastRecordModel, WeatherDataModel,
#     DataEntryLineModel
# )
...
#             return self._get_error_response(current_tariff)
#
#     # ... методи save_forecast_to_db та convert_iso_to_datetime залиш без змін ...
#
