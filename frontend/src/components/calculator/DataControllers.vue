      ...
      <div class="input-group">
        <form action="" class="w-100">
          <div class="row p-0">
            ...
            <div class="col-12 col-sm-12 col-md-4 pl-0 pr-0 pt-3 pb-3">
    ...
    <div class="col-xl-3 col-md-9">
      <div class="row pr-1 setup-data-section p-0 pt-2 pb-2">
        ...
        <div class="col-1 col-xl-2 col-sm-1 d-flex justify-content-end align-items-baseline p-0">
          ...
          <button class="btn card-light text-purple p-0 my-auto mx-auto btn-sm" @click="currentView = currentView === 'settings' ? 'table' : 'settings'"
