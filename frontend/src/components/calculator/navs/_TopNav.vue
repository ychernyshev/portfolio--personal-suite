...
<template>
  <header class="header row">
    <div class="col-xl-3 col-xs-12 col-sm-12 col-md-12 logo-container">
      <div class="logo w-75">Solar Power Calculator</div>
    </div>
...
<!--            Source code-->
<!--          </a>-->
<!--          <a href="#" class="nav-item my-auto fw-bold text-success d-flex align-items-center">-->
...
<!--            Contact me-->
<!--          </a>-->
<!--          <a href="#" class="text-purple text-center">-->
