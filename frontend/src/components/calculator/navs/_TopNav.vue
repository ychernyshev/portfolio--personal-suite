...
<!--          </a>-->
        ...
        <div class="card border-0 neomorphic text-purple p-2 additional-button-group justify-content-around">
          ...
          <button-comp title="" class="neomorphic right-angle p-2 p-sm-3 p-md-4 p-xl-2 text-purple" style="font-size: 0.9rem">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-graph-up text-purple additional-button-icon" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M0 0h1v15h15v1H0zm14.817 3.113a.5.5 0 0 1 .07.704l-4.5 5.5a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61 4.15-5.073a.5.5 0 0 1 .704-.07"/>
            </svg>
          </button-comp>
          <button-comp title="" class="neomorphic right-angle p-2 p-sm-3 p-md-4 p-xl-2 text-purple" style="font-size: 0.9rem">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-file-bar-graph-fill text-purple additional-button-icon" viewBox="0 0 16 16">
          ...
          <button-comp title="" class="neomorphic right-angle p-2 p-sm-3 p-md-4 p-xl-2 text-purple" style="font-size: 0.9rem">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-text-indent-left text-purple additional-button-icon" viewBox="0 0 16 16">
