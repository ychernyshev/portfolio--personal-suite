<script setup>
// Приймаємо тип погоди (sun, cloud, snow тощо)
...
<template>
  <span v-if="type === 'sun'" title="Sunny">
    <svg
  ...
  <span v-else-if="type === 'cloud'" title="Cloudy">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
      height="20"
  ...
  <span v-else-if="type === 'snow'" title="Snowy">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="20"
      height="20"
