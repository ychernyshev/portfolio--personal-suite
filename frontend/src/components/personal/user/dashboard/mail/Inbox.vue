        ...
        <div class="d-flex flex-row align-items-center">
          <div class="shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center p-1">
            <button
                ...
                type="button"
                class="ps-2 pe-2 border-0 bg-transparent">
          ...
          <div
              class="shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center p-1">
            <button
...
.shadow:hover {
  box-shadow: 0 0.3rem 0.7rem 0.3rem rgba(0, 0, 0, 0.1) !important;
}
</style>